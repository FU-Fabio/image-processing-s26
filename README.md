# FU Berlin - Image Processing SoSe 26
...
4. I fetch your code when the assignment is due. (Every Thursday at 12:00 pm, i.e., noon)
...
```
$ git clone --origin upstream https://github.com/goehring/image-processing-s26
```

Get into the new folder

```
$ cd image-processing-s26
```
